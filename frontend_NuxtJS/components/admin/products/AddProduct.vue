<template>
  ...
  >
    <div class="flex flex-col justify-center add_product">
      ...
      <a-form-model-item label="Images">
        <div class="mt-6">
      ...
      <div class="grid grid-cols-2 gap-7">
        ...
        <a-form-model-item ref="originalPrice" label="originalPrice" prop="originalPrice">
          <a-input
    ...
    onSubmit () {
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          ...
          this.$toast.success('Add product successful', { timeout: 1500 })
          this.form.images = []
        } else {
