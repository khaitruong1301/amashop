<template>
  <div>
    <a-modal v-model="visible" :footer="null" title="Order List" width="{980}" class="modal_detail max-h-[50vh] overflow-y-auto">
      <a-table
        :columns="columns"
          ...
          <div class="flex flex-col">
            <div>
              ...
              <div class="flex sm:w-full sm:flex-row flex-col  sm:space-x-3">
                <a-form-model-item label="Transport fee" class="w-full">
                  <a-input
                    v-model="fee"
                    disabled
                    addon-after="USD"
                ...
                <a-form-model-item label="Total price" class="w-full">
                  <a-input
                    v-model="totalPrice"
                    disabled
                    addon-after="USD"
